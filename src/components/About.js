...
const About = () => (
    <section id="two">
        ...
        <p>My goal is to bring together my skills in customer experience and web development and help to create the ideal experience for all end users. </p>
        <p>In my free time I love to play video games, write, rap, and record music.</p>
        <ul className="actions">
            <li><a href="/resume" className="button" target="_blank"> My Resume</a></li>
